...
void BoardScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (BoardScene::*)(int , int , int );
            if (_t _q_method = &BoardScene::piecePlaced; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (BoardScene::*)(int );
            if (_t _q_method = &BoardScene::gameOver; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (BoardScene::*)(int );
            if (_t _q_method = &BoardScene::currentPlayerChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void BoardScene::piecePlaced(int _t1, int _t2, int _t3)
{
...
// SIGNAL 1
void BoardScene::gameOver(int _t1)
{
...
// SIGNAL 2
void BoardScene::currentPlayerChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
