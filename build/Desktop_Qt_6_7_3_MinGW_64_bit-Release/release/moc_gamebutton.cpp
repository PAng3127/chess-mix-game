...
constexpr auto qt_meta_stringdata_CLASSGameButtonENDCLASS = QtMocHelpers::stringData(
    "GameButton",
    "gameSelected",
    "",
    "gameId"
...
void GameButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->gameSelected((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameButton::*)(const QString & );
            if (_t _q_method = &GameButton::gameSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameButton::gameSelected(const QString & _t1)
{
